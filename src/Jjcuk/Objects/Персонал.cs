...
namespace IIS.Jjcuk
{
    ...
    public class Персонал : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Jjcuk.Должности fДолжности;
        ...
        [PropertyStorage(new string[] {
                "Должности"})]
        [NotNull()]
        public virtual IIS.Jjcuk.Должности Должности
        {
            get
            {
                ...
                IIS.Jjcuk.Должности result = this.fДолжности;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПерсоналE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналE", typeof(IIS.Jjcuk.Персонал));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПерсоналL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПерсоналL", typeof(IIS.Jjcuk.Персонал));
                }
            }
        }
    }
