...
namespace IIS.Jjcuk
{
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Jjcuk.Контрагент fКонтрагент;
        
        private IIS.Jjcuk.Организация fОрганизация;
        
        private IIS.Jjcuk.РукОтдЛог fРукОтдЛог;
        ...
        [PropertyStorage(new string[] {
                "Контрагент"})]
        [NotNull()]
        public virtual IIS.Jjcuk.Контрагент Контрагент
        {
            get
            {
                ...
                IIS.Jjcuk.Контрагент result = this.fКонтрагент;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.Jjcuk.Организация Организация
        {
            get
            {
                ...
                IIS.Jjcuk.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "РукОтдЛог"})]
        [NotNull()]
        public virtual IIS.Jjcuk.РукОтдЛог РукОтдЛог
        {
            get
            {
                ...
                IIS.Jjcuk.РукОтдЛог result = this.fРукОтдЛог;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Jjcuk.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Jjcuk.Договор));
                }
            }
        }
    }
