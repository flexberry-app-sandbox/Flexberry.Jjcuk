...
namespace IIS.Jjcuk
{
    ...
    public class РукОтдЛог : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Jjcuk.Персонал fПерсонал;
        ...
        [PropertyStorage(new string[] {
                "Персонал"})]
        [NotNull()]
        public virtual IIS.Jjcuk.Персонал Персонал
        {
            get
            {
                ...
                IIS.Jjcuk.Персонал result = this.fПерсонал;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РукОтдЛогE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РукОтдЛогE", typeof(IIS.Jjcuk.РукОтдЛог));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РукОтдЛогL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РукОтдЛогL", typeof(IIS.Jjcuk.РукОтдЛог));
                }
            }
        }
    }
